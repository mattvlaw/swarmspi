...
if __name__=='__main__':
    ...
    rospy.sleep(8)
    p.kill()
    begin_sub = rospy.Subscriber('/201907two/ProjectBegin2', String, callback=show_begin)
    finish_sub = rospy.Subscriber('/201907two/ProjectFinal2', String, callback=show_final)
    waypoint_sub = rospy.Subscriber('/201907two/WayPointNum2', Float32, callback=show_waypoint)
    print("spinning")
